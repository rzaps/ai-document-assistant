...
example_questions = [
    "Сделай краткое резюме для новичка",
    "Какие важные пункты нельзя пропустить?",
    "Объясни инструкцию простыми шагами",
    "Какие ошибки могут допустить сотрудники?",
    "Сделай чек-лист из документа",
]
